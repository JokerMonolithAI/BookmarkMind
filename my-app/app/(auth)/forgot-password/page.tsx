    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-white to-gray-50 p-4">
      <div className="max-w-md w-full space-y-6 p-8 bg-white rounded-xl shadow-sm border border-gray-100">
        <div className="text-center">
          ...
          <h2 className="mt-4 text-2xl font-semibold text-gray-900 tracking-tight">忘记密码</h2>
          <p className="mt-1 text-sm text-gray-500">我们将向您的邮箱发送密码重置链接</p>
        </div>
        ...
        {success ? (
          <div className="space-y-6">
            <div className="bg-green-50 p-4 rounded-md flex items-start">
              ...
              <div>
                <h3 className="text-sm font-medium text-green-800">重置链接已发送</h3>
